...
| `synthetic_data/generate_synthetic_data.ipynb` | Notebook that writes the paper's synthetic inputs (fake spectrum and one flux table per band under HEASoft, light curves of both fiducial systems in every band) with diagnostic plots |
